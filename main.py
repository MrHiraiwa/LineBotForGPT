...
def lineBot():
    try:
        ...
        def update_in_transaction(transaction, doc_ref):
            ...
            if any(change_text in userMessage for change_text in CHANGE_TO_TEXT) and not exec_functions and (VOICE_ON == 'True' or VOICE_ON == 'Reply'):
            ...
            if any(change_voice in userMessage for change_voice in CHANGE_TO_VOICE) and not exec_functions and (VOICE_ON == 'True' or VOICE_ON == 'Reply'):
            ...
            user['messages'].append({'role': 'user', 'content': nowDateStr + " " + headMessage + "\n" + display_name + ":" + userMessage})
