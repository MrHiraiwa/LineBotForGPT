...
def reload_settings():
    global GPT_MODEL, BOT_NAME, SYSTEM_PROMPT_EX, SYSTEM_PROMPT, PREVIOUS_DUMMY_USER_MESSAGE1, PREVIOUS_DUMMY_ASSISTANT_MESSAGE1, PREVIOUS_DUMMY_USER_MESSAGE2, PREVIOUS_DUMMY_ASSISTANT_MESSAGE2, MAX_TOKEN_NUM, MAX_DAILY_USAGE, GROUP_MAX_DAILY_USAGE, FREE_LIMIT_DAY, MAX_DAILY_MESSAGE, ERROR_MESSAGE, FORGET_KEYWORDS, FORGET_GUIDE_MESSAGE, FORGET_MESSAGE, FORGET_QUICK_REPLY, SEARCH_KEYWORDS, SEARCH_GUIDE_MESSAGE, SEARCH_MESSAGE, FAIL_SEARCH_MESSAGE, SEARCH_QUICK_REPLY,SEARCH_LANG, NG_KEYWORDS, NG_MESSAGE, STICKER_MESSAGE, FAIL_STICKER_MESSAGE, OCR_MESSAGE, MAPS_KEYWORDS, MAPS_FILTER_KEYWORDS, MAPS_GUIDE_MESSAGE, MAPS_MESSAGE, MAPS_QUICK_REPLY, VOICE_ON, VOICE_OR_TEXT_KEYWORDS, VOICE_OR_TEXT_GUIDE_MESSAGE, CHANGE_TO_TEXT_MESSAGE, CHANGE_TO_VOICE_MESSAGE, OR_TEXT_QUICK_REPLY, OR_VOICE_QUICK_REPLY, VOICE_SPEED_KEYWORDS, VOICE_SPEED_GUIDE_MESSAGE, VOICE_SPEED_SLOW_MESSAGE, VOICE_SPEED_NORMAL_MESSAGE, VOICE_SPEED_FAST_MESSAGE, VOICE_SPEED_SLOW_QUICK_REPLY, VOICE_SPEED_NORMAL_QUICK_REPLY, VOICE_SPEED_FAST_QUICK_REPLY, OR_ENGLISH_KEYWORDS,OR_ENGLISH_GUIDE_MESSAGE, CHANGE_TO_AMERICAN_MESSAGE, CHANGE_TO_BRIDISH_MESSAGE, CHANGE_TO_AUSTRALIAN_MESSAGE, CHANGE_TO_INDIAN_MESSAGE, OR_ENGLISH_AMERICAN_QUICK_REPLY, OR_ENGLISH_BRIDISH_QUICK_REPLY, OR_ENGLISH_AUSTRALIAN_QUICK_REPLY, OR_ENGLISH_INDIAN_QUICK_REPLY, OR_CHINESE_KEYWORDS, OR_CHINESE_GUIDE_MESSAGE, CHANGE_TO_MANDARIN_MESSAGE, CHANGE_TO_CANTONESE_MESSAGE, OR_CHINESE_MANDARIN_QUICK_REPLY, OR_CHINESE_CANTONESE_QUICK_REPLY, BACKET_NAME, FILE_AGE, PAYMENT_KEYWORDS, PAYMENT_PRICE_ID, PAYMENT_GUIDE_MESSAGE, PAYMENT_QUICK_REPLY, PAYMENT_RESULT_URL
