    ...
    try:
        ...
        def update_in_transaction(transaction, doc_ref):
            ...
            if userMessage.strip() == FORGET_QUICK_REPLY:
                ...
                exec_functions = True
                result = search(web_search_keywords, SUCCESS_SEARCH_MESSAGE, FAIL_SEARCH_MESSAGE, SEARCH_LANG)
            ...
            if any(word in userMessage for word in PAYMENT_KEYWORDS) and not exec_functions and (VOICE_ON == 'True' or VOICE_ON == 'Reply') and sourceType == "user":
