...
DEFAULT_ENV_VARS = {
    ...
    'OR_CHINESE_GUIDE_MESSAGE': 'ユーザーに「画面下の「北京語で返信」又は「広東語で返信」のリンクをタップすると私の音声設定が変更される」と案内してください。以下の文章はユーザーから送られたものです。',
