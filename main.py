...
DEFAULT_ENV_VARS = {
    ...
    'SEARCH_GUIDE_MESSAGE': 'ユーザーに「画面下の「インターネットで検索」の項目をタップすると検索結果が表示される」と案内してください。以下の文章はユーザーから送られたものです。',
    ...
    'MAPS_GUIDE_MESSAGE': 'ユーザーに「画面下の「地図で検索」の項目をタップすると検索結果が表示される」と案内してください。以下の文章はユーザーから送られたものです。 ',
